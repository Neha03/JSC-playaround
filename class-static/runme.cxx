...
cout<<"main() called"<<endl;
  ...
  // Create classes
  JSFoo_DeclareClass(Context, GlobalObject, "Foo");

  // Create static class member functions
  DefineJSCoreFunction(Context, GlobalObject, "Foo_printMe", JSFoo_printMe);		// helper print function
  ...
  if (Result) 
	printf("Foo script executed successfully\n");
		
  else {
	printf("Foo script Exception\n");
